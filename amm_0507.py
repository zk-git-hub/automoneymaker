...
time.sleep(0.2)
post_message(myToken,"#amm", "  라이트코인-LTC")
time.sleep(0.2)
...
time.sleep(0.2)
post_message(myToken,"#amm", "  체인링크-LINK")
time.sleep(0.2)
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=200):
            ...
            print ("buy1")
            if target_price_btc < current_price_btc and 160000 > btc*current_price_btc:
            ...
            print ("buy2")
            if target_price_eth < current_price_eth and 160000 > eth*current_price_eth:
            ...
            print ("buy3")
            if target_price_eos < current_price_eos and 160000 > eos*current_price_eos:
            ...
            print ("buy4")
            if target_price_doge < current_price_doge and 160000 > doge*current_price_doge:
            ...
            print ("buy5")
            if target_price_xrp < current_price_xrp and 160000 > xrp*current_price_xrp:
            ...
            print ("buy6")
            if target_price_ada < current_price_ada and 160000 > ada*current_price_ada:
            ...
            print ("buy7")
            if target_price_chz < current_price_chz and 160000 > chz*current_price_chz:
                if krw > 500500 and yesterday_price_chz*1.1 > current_price_chz:
                    buy_result = upbit.buy_market_order("KRW-CHZ", 500000)
                    post_message(myToken,"#amm", "CHZ buy : 타겟 구매")
            time.sleep(0.5)

            print ("buy8")
            if target_price_ltc < current_price_ltc and 160000 > ltc*current_price_ltc:
                if krw > 500500 and yesterday_price_ltc*1.1 > current_price_ltc:
                    buy_result = upbit.buy_market_order("KRW-LTC", 500000)
                    post_message(myToken,"#amm", "LTC buy : 타겟 구매")
            time.sleep(0.5)

            print ("buy9")
            if target_price_pci < current_price_pci and 160000 > pci*current_price_pci:
            ...
            print ("buy10")
            if target_price_vet < current_price_vet and 160000 > vet*current_price_vet:
            ...
            print ("buy11")
            if target_price_etc < current_price_etc and 160000 > etc*current_price_etc:
            ...
            print ("buy12")
            if target_price_link < current_price_link and 160000 > link*current_price_link:
                if krw > 500500 and yesterday_price_link*1.1 > current_price_link:
                    buy_result = upbit.buy_market_order("KRW-LINK", 500000)
                    post_message(myToken,"#amm", "LINK buy : 타겟 구매")
            time.sleep(0.5)

            print ("buy13")
            if target_price_btg < current_price_btg and 160000 > btg*current_price_btg:
            ...
            print ("buy14")
            if target_price_bch < current_price_bch and 160000 > bch*current_price_bch:
            ...
            print ("buy15")
            if target_price_neo < current_price_neo and 160000 > neo*current_price_neo:
            ...
            if target_price_chz*1.20 < current_price_chz:
                if chz*current_price_chz > 299999:
                    sell_result = upbit.sell_market_order("KRW-CHZ", chz*0.5)
            ...
            if target_price_ltc*1.20 < current_price_ltc:
                if ltc*current_price_ltc > 299999:
                    ...
                    post_message(myToken,"#amm", "LTC sell: 익절 흐믓")
            time.sleep(0.5)
            ...
            if target_price_link*1.20 < current_price_link:
                if link*current_price_link > 299999:
                    ...
                    post_message(myToken,"#amm", "LINK sell: 익절 흐믓")
            time.sleep(0.5)
            ...
            print ("gazua7")
            if current_price_chz < yesterday_price_chz*0.90 and current_price_chz > yesterday_price_chz*0.82 and 200000 > chz*current_price_chz:
                if krw > 200100:
            ...
            if current_price_ltc < yesterday_price_ltc*0.90 and current_price_ltc > yesterday_price_ltc*0.82 and 200000 > ltc*current_price_ltc:
                if krw > 200100:
                    ...
                    post_message(myToken,"#amm", "LTC buy : 가즈아 구매")
            time.sleep(0.5)
            ...
            if current_price_link < yesterday_price_link*0.90 and current_price_link > yesterday_price_link*0.82 and 200000 > link*current_price_link:
                if krw > 200100:
                    ...
                    post_message(myToken,"#amm", "LINK buy : 가즈아 구매")
            time.sleep(0.5)
            ...
            if current_price_btc < target_price_btc*0.95:
                if btc*current_price_btc > 400000:
                    ...
                    post_message(myToken,"#amm", "BTC sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_eth < target_price_eth*0.95:
                if eth*current_price_eth > 400000:
                    ...
                    post_message(myToken,"#amm", "ETH sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_eos < target_price_eos*0.95:
                if eos*current_price_eos > 400000:
                    ...
                    post_message(myToken,"#amm", "EOS sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_doge < target_price_doge*0.95:
                if doge*current_price_doge > 400000:
                    ...
                    post_message(myToken,"#amm", "DOGE sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_xrp < target_price_xrp*0.95:
                if xrp*current_price_xrp > 400000:
                    ...
                    post_message(myToken,"#amm", "XRP sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_ada < target_price_ada*0.95:
                if ada*current_price_ada > 400000:
                    ...
                    post_message(myToken,"#amm", "ADA sell : 앗 나의 실수")
            time.sleep(0.5)

            print ("sonjul7")    
            if current_price_chz < target_price_chz*0.95:
                if chz*current_price_chz > 400000:
                    sell_result = upbit.sell_market_order("KRW-CHZ", chz*0.75)
                    post_message(myToken,"#amm", "CHZ sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_ltc < target_price_ltc*0.95:
                if ltc*current_price_ltc > 400000:
                    ...
                    post_message(myToken,"#amm", "LTC sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_pci < target_price_pci*0.95:
                if pci*current_price_pci > 400000:
                    ...
                    post_message(myToken,"#amm", "PCI sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_vet < target_price_vet*0.95:
                if vet*current_price_vet > 400000:
                    ...
                    post_message(myToken,"#amm", "VET sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_etc < target_price_etc*0.95:
                if etc*current_price_etc > 400000:
                    ...
                    post_message(myToken,"#amm", "ETC sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_link < target_price_link*0.95:
                if link*current_price_link > 400000:
                    ...
                    post_message(myToken,"#amm", "LINK sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_btg < target_price_btg*0.95:
                if btg*current_price_btg > 400000:
                    ...
                    post_message(myToken,"#amm", "BTG sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_bch < target_price_bch*0.95:
                if bch*current_price_bch > 400000:
                    ...
                    post_message(myToken,"#amm", "BCH sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_neo < target_price_neo*0.95:
                if neo*current_price_neo > 400000:
                    ...
                    post_message(myToken,"#amm", "NEO sell : 앗 나의 실수")
            time.sleep(0.5)
            ...
            if current_price_ltc < yesterday_price_ltc*0.8:
                if ltc*current_price_ltc > 5000:
                    ...
                    post_message(myToken,"#amm", "LTC sell all: 망했어요")
            time.sleep(0.5)
            ...
            if current_price_link < yesterday_price_link*0.8:
                if link*current_price_link > 5000:
                    ...
                    post_message(myToken,"#amm", "LINK sell all: 망했어요")
            time.sleep(0.5)
        ...
        #장마감 - 가진거 다팔아
            ...
            if ltc*current_price_ltc > 5000:
                sell_result = upbit.sell_market_order("KRW-LTC", ltc*0.9995)
                post_message(myToken,"#amm", "LTC sell all : 장마감")
            ...
            if link*current_price_link > 5000:
                sell_result = upbit.sell_market_order("KRW-LINK", link*0.9995)
                post_message(myToken,"#amm", "LINK sell all : 장마감")
