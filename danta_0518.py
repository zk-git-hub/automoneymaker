...
# 시작 메세지 슬랙 전송
post_message(myToken,"#amm", "Project Danta_0518")
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=200):
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_doge")
            if current_price_doge > yesterday_price_doge and 10000 > doge*doge_avg and doge_avg*1.002 < current_price_doge :
                if krw > 200200:
            ...
            print ("upsell_doge")
            if current_price_doge > yesterday_price_doge and doge_avg*1.01 < current_price_doge :
                if doge*current_price_doge > 5000:
                    sell_result = upbit.sell_market_order("KRW-DOGE", doge*0.9995)
                    post_message(myToken,"#amm", "DOGE sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-DOGE", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_doge")
            if current_price_doge < yesterday_price_doge and 10000 > doge*doge_avg and doge_avg*0.96 > current_price_doge :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-DOGE", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_doge")
            if doge_avg*0.992 > current_price_doge:
                if doge*current_price_doge > 5000:
                    sell_result = upbit.sell_market_order("KRW-DOGE", doge*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_eth")
            if current_price_eth > yesterday_price_eth and 10000 > eth*eth_avg and eth_avg*1.002 < current_price_eth :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_eth")
            if current_price_eth > yesterday_price_eth and eth_avg*1.01 < current_price_eth :
                if eth*current_price_eth > 5000:
                    sell_result = upbit.sell_market_order("KRW-ETH", eth*0.9995)
                    post_message(myToken,"#amm", "ETH sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-ETH", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_eth")
            if current_price_eth < yesterday_price_eth and 10000 > eth*eth_avg and eth_avg*0.96 > current_price_eth :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-ETH", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_eth")
            if eth_avg*0.992 > current_price_eth:
                if eth*current_price_eth > 5000:
                    sell_result = upbit.sell_market_order("KRW-ETH", eth*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_eos")
            if current_price_eos > yesterday_price_eos and 10000 > eos*eos_avg and eos_avg*1.002 < current_price_eos :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_eos")
            if current_price_eos > yesterday_price_eos and eos_avg*1.01 < current_price_eos :
                if eos*current_price_eos > 5000:
                    sell_result = upbit.sell_market_order("KRW-EOS", eos*0.9995)
                    post_message(myToken,"#amm", "EOS sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-EOS", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_eos")
            if current_price_eos < yesterday_price_eos and 10000 > eos*eos_avg and eos_avg*0.96 > current_price_eos :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-EOS", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_eos")
            if eos_avg*0.992 > current_price_eos:
                if eos*current_price_eos > 5000:
                    sell_result = upbit.sell_market_order("KRW-EOS", eos*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_etc")
            if current_price_etc > yesterday_price_etc and 10000 > etc*etc_avg and etc_avg*1.002 < current_price_etc :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_etc")
            if current_price_etc > yesterday_price_etc and etc_avg*1.01 < current_price_etc :
                if etc*current_price_etc > 5000:
                    sell_result = upbit.sell_market_order("KRW-ETC", etc*0.9995)
                    post_message(myToken,"#amm", "ETC sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-ETC", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_etc")
            if current_price_etc < yesterday_price_etc and 10000 > etc*etc_avg and etc_avg*0.96 > current_price_etc :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-ETC", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_etc")
            if etc_avg*0.992 > current_price_etc:
                if etc*current_price_etc > 5000:
                    sell_result = upbit.sell_market_order("KRW-ETC", etc*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_xrp")
            if current_price_xrp > yesterday_price_xrp and 10000 > xrp*xrp_avg and xrp_avg*1.002 < current_price_xrp :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_xrp")
            if current_price_xrp > yesterday_price_xrp and xrp_avg*1.01 < current_price_xrp :
                if xrp*current_price_xrp > 5000:
                    sell_result = upbit.sell_market_order("KRW-XRP", xrp*0.9995)
                    post_message(myToken,"#amm", "XRP sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-XRP", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_xrp")
            if current_price_xrp < yesterday_price_xrp and 10000 > xrp*xrp_avg and xrp_avg*0.96 > current_price_xrp :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-XRP", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_xrp")
            if xrp_avg*0.992 > current_price_xrp:
                if xrp*current_price_xrp > 5000:
                    sell_result = upbit.sell_market_order("KRW-XRP", xrp*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_btc")
            if current_price_btc > yesterday_price_btc and 10000 > btc*btc_avg and btc_avg*1.002 < current_price_btc :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_btc")
            if current_price_btc > yesterday_price_btc and btc_avg*1.01 < current_price_btc :
                if btc*current_price_btc > 5000:
                    sell_result = upbit.sell_market_order("KRW-BTC", btc*0.9995)
                    post_message(myToken,"#amm", "BTC sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-BTC", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_btc")
            if current_price_btc < yesterday_price_btc and 10000 > btc*btc_avg and btc_avg*0.96 > current_price_btc :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-BTC", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_btc")
            if btc_avg*0.992 > current_price_btc:
                if btc*current_price_btc > 5000:
                    sell_result = upbit.sell_market_order("KRW-BTC", btc*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_ada")
            if current_price_ada > yesterday_price_ada and 10000 > ada*ada_avg and ada_avg*1.002 < current_price_ada :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_ada")
            if current_price_ada > yesterday_price_ada and ada_avg*1.01 < current_price_ada :
                if ada*current_price_ada > 5000:
                    sell_result = upbit.sell_market_order("KRW-ADA", ada*0.9995)
                    post_message(myToken,"#amm", "ADA sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-ADA", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_ada")
            if current_price_ada < yesterday_price_ada and 10000 > ada*ada_avg and ada_avg*0.96 > current_price_ada :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-ADA", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_ada")
            if ada_avg*0.992 > current_price_ada:
                if ada*current_price_ada > 5000:
                    sell_result = upbit.sell_market_order("KRW-ADA", ada*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_bch")
            if current_price_bch > yesterday_price_bch and 10000 > bch*bch_avg and bch_avg*1.002 < current_price_bch :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_bch")
            if current_price_bch > yesterday_price_bch and bch_avg*1.01 < current_price_bch :
                if bch*current_price_bch > 5000:
                    sell_result = upbit.sell_market_order("KRW-BCH", bch*0.9995)
                    post_message(myToken,"#amm", "BCH sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-BCH", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_bch")
            if current_price_bch < yesterday_price_bch and 10000 > bch*bch_avg and bch_avg*0.96 > current_price_bch :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-BCH", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_bch")
            if bch_avg*0.992 > current_price_bch:
                if bch*current_price_bch > 5000:
                    sell_result = upbit.sell_market_order("KRW-BCH", bch*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_vet")
            if current_price_vet > yesterday_price_vet and 10000 > vet*vet_avg and vet_avg*1.002 < current_price_vet :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_vet")
            if current_price_vet > yesterday_price_vet and vet_avg*1.01 < current_price_vet :
                if vet*current_price_vet > 5000:
                    sell_result = upbit.sell_market_order("KRW-VET", vet*0.9995)
                    post_message(myToken,"#amm", "VET sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-VET", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_vet")
            if current_price_vet < yesterday_price_vet and 10000 > vet*vet_avg and vet_avg*0.96 > current_price_vet :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-VET", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_vet")
            if vet_avg*0.992 > current_price_vet:
                if vet*current_price_vet > 5000:
                    sell_result = upbit.sell_market_order("KRW-VET", vet*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_neo")
            if current_price_neo > yesterday_price_neo and 10000 > neo*neo_avg and neo_avg*1.002 < current_price_neo :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_neo")
            if current_price_neo > yesterday_price_neo and neo_avg*1.01 < current_price_neo :
                if neo*current_price_neo > 5000:
                    sell_result = upbit.sell_market_order("KRW-NEO", neo*0.9995)
                    post_message(myToken,"#amm", "NEO sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-NEO", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_neo")
            if current_price_neo < yesterday_price_neo and 10000 > neo*neo_avg and neo_avg*0.96 > current_price_neo :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-NEO", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_neo")
            if neo_avg*0.992 > current_price_neo:
                if neo*current_price_neo > 5000:
                    sell_result = upbit.sell_market_order("KRW-NEO", neo*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_link")
            if current_price_link > yesterday_price_link and 10000 > link*link_avg and link_avg*1.002 < current_price_link :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_link")
            if current_price_link > yesterday_price_link and link_avg*1.01 < current_price_link :
                if link*current_price_link > 5000:
                    sell_result = upbit.sell_market_order("KRW-LINK", link*0.9995)
                    post_message(myToken,"#amm", "LINK sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-LINK", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_link")
            if current_price_link < yesterday_price_link and 10000 > link*link_avg and link_avg*0.96 > current_price_link :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-LINK", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_link")
            if link_avg*0.992 > current_price_link:
                if link*current_price_link > 5000:
                    sell_result = upbit.sell_market_order("KRW-LINK", link*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_bat")
            if current_price_bat > yesterday_price_bat and 10000 > bat*bat_avg and bat_avg*1.002 < current_price_bat :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_bat")
            if current_price_bat > yesterday_price_bat and bat_avg*1.01 < current_price_bat :
                if bat*current_price_bat > 5000:
                    sell_result = upbit.sell_market_order("KRW-BAT", bat*0.9995)
                    post_message(myToken,"#amm", "BAT sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-BAT", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_bat")
            if current_price_bat < yesterday_price_bat and 10000 > bat*bat_avg and bat_avg*0.96 > current_price_bat :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-BAT", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_bat")
            if bat_avg*0.992 > current_price_bat:
                if bat*current_price_bat > 5000:
                    sell_result = upbit.sell_market_order("KRW-BAT", bat*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_ltc")
            if current_price_ltc > yesterday_price_ltc and 10000 > ltc*ltc_avg and ltc_avg*1.002 < current_price_ltc :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_ltc")
            if current_price_ltc > yesterday_price_ltc and ltc_avg*1.01 < current_price_ltc :
                if ltc*current_price_ltc > 5000:
                    sell_result = upbit.sell_market_order("KRW-LTC", ltc*0.9995)
                    post_message(myToken,"#amm", "LTC sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-LTC", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_ltc")
            if current_price_ltc < yesterday_price_ltc and 10000 > ltc*ltc_avg and ltc_avg*0.96 > current_price_ltc :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-LTC", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_ltc")
            if ltc_avg*0.992 > current_price_ltc:
                if ltc*current_price_ltc > 5000:
                    sell_result = upbit.sell_market_order("KRW-LTC", ltc*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_btg")
            if current_price_btg > yesterday_price_btg and 10000 > btg*btg_avg and btg_avg*1.002 < current_price_btg :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_btg")
            if current_price_btg > yesterday_price_btg and btg_avg*1.01 < current_price_btg :
                if btg*current_price_btg > 5000:
                    sell_result = upbit.sell_market_order("KRW-BTG", btg*0.9995)
                    post_message(myToken,"#amm", "BTG sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-BTG", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_btg")
            if current_price_btg < yesterday_price_btg and 10000 > btg*btg_avg and btg_avg*0.96 > current_price_btg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-BTG", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_btg")
            if btg_avg*0.992 > current_price_btg:
                if btg*current_price_btg > 5000:
                    sell_result = upbit.sell_market_order("KRW-BTG", btg*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_pci")
            if current_price_pci > yesterday_price_pci and 10000 > pci*pci_avg and pci_avg*1.002 < current_price_pci :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_pci")
            if current_price_pci > yesterday_price_pci and pci_avg*1.01 < current_price_pci :
                if pci*current_price_pci > 5000:
                    sell_result = upbit.sell_market_order("KRW-PCI", pci*0.9995)
                    post_message(myToken,"#amm", "PCI sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-PCI", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_pci")
            if current_price_pci < yesterday_price_pci and 10000 > pci*pci_avg and pci_avg*0.96 > current_price_pci :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-PCI", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_pci")
            if pci_avg*0.992 > current_price_pci:
                if pci*current_price_pci > 5000:
                    sell_result = upbit.sell_market_order("KRW-PCI", pci*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_qtum")
            if current_price_qtum > yesterday_price_qtum and 10000 > qtum*qtum_avg and qtum_avg*1.002 < current_price_qtum :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_qtum")
            if current_price_qtum > yesterday_price_qtum and qtum_avg*1.01 < current_price_qtum :
                if qtum*current_price_qtum > 5000:
                    sell_result = upbit.sell_market_order("KRW-QTUM", qtum*0.9995)
                    post_message(myToken,"#amm", "QTUM sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-QTUM", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_qtum")
            if current_price_qtum < yesterday_price_qtum and 10000 > qtum*qtum_avg and qtum_avg*0.96 > current_price_qtum :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-QTUM", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_qtum")
            if qtum_avg*0.992 > current_price_qtum:
                if qtum*current_price_qtum > 5000:
                    sell_result = upbit.sell_market_order("KRW-QTUM", qtum*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_xlm")
            if current_price_xlm > yesterday_price_xlm and 10000 > xlm*xlm_avg and xlm_avg*1.002 < current_price_xlm :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_xlm")
            if current_price_xlm > yesterday_price_xlm and xlm_avg*1.01 < current_price_xlm :
                if xlm*current_price_xlm > 5000:
                    sell_result = upbit.sell_market_order("KRW-XLM", xlm*0.9995)
                    post_message(myToken,"#amm", "XLM sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-XLM", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_xlm")
            if current_price_xlm < yesterday_price_xlm and 10000 > xlm*xlm_avg and xlm_avg*0.96 > current_price_xlm :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-XLM", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_xlm")
            if xlm_avg*0.992 > current_price_xlm:
                if xlm*current_price_xlm > 5000:
                    sell_result = upbit.sell_market_order("KRW-XLM", xlm*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_chz")
            if current_price_chz > yesterday_price_chz and 10000 > chz*chz_avg and chz_avg*1.002 < current_price_chz :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_chz")
            if current_price_chz > yesterday_price_chz and chz_avg*1.01 < current_price_chz :
                if chz*current_price_chz > 5000:
                    sell_result = upbit.sell_market_order("KRW-CHZ", chz*0.9995)
                    post_message(myToken,"#amm", "CHZ sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-CHZ", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_chz")
            if current_price_chz < yesterday_price_chz and 10000 > chz*chz_avg and chz_avg*0.96 > current_price_chz :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-CHZ", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_chz")
            if chz_avg*0.992 > current_price_chz:
                if chz*current_price_chz > 5000:
                    sell_result = upbit.sell_market_order("KRW-CHZ", chz*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_snt")
            if current_price_snt > yesterday_price_snt and 10000 > snt*snt_avg and snt_avg*1.002 < current_price_snt :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_snt")
            if current_price_snt > yesterday_price_snt and snt_avg*1.01 < current_price_snt :
                if snt*current_price_snt > 5000:
                    sell_result = upbit.sell_market_order("KRW-SNT", snt*0.9995)
                    post_message(myToken,"#amm", "SNT sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-SNT", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_snt")
            if current_price_snt < yesterday_price_snt and 10000 > snt*snt_avg and snt_avg*0.96 > current_price_snt :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-SNT", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_snt")
            if snt_avg*0.992 > current_price_snt:
                if snt*current_price_snt > 5000:
                    sell_result = upbit.sell_market_order("KRW-SNT", snt*0.9995)
            ...
            #상승장 매수 시나리오 : 오르면 무조건 삽니다
            print ("upbuy_dot")
            if current_price_dot > yesterday_price_dot and 10000 > dot*dot_avg and dot_avg*1.002 < current_price_dot :
                if krw > 200200:
            ...
            #상승장 매도 시나리오: 평단가 1%이상 상승 시
            print ("upsell_dot")
            if current_price_dot > yesterday_price_dot and dot_avg*1.01 < current_price_dot :
                if dot*current_price_dot > 5000:
                    sell_result = upbit.sell_market_order("KRW-DOT", dot*0.9995)
                    post_message(myToken,"#amm", "DOT sell: 상승장 +1% 익절")
                    time.sleep(0.2)
                    buy_result = upbit.buy_market_order("KRW-DOT", 5000)

            #하락장 매수 시나리오 : 마이 내리면 삽니다
            print ("downbuy_dot")
            if current_price_dot < yesterday_price_dot and 10000 > dot*dot_avg and dot_avg*0.96 > current_price_dot :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-DOT", 200000)
            ...
            #평단가 1%이상 하락시, 팔아
            print ("sonjul_dot")
            if dot_avg*0.992 > current_price_dot:
                if dot*current_price_dot > 5000:
                    sell_result = upbit.sell_market_order("KRW-DOT", dot*0.9995)
