...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=120):
            ...
            yesterday_price = get_yesterday_price("KRW-BTC")
            ...
            if current_price < yesterday_price*0.95 and current_price > yesterday_price*0.82 and 10000 > btc*current_price:
                if krw > 101000:
    ...
    #에러메세지 출력
        ...
        print(e)
        post_message(myToken,"#amm", "BTC error : " +e)
        time.sleep(1)