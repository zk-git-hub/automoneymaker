...
# 시작 메세지 슬랙 전송
post_message(myToken,"#amm", "Project Danta_0516")
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=200):
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_doge")
            if current_price_doge > yesterday_price_doge*0.90 and 10000 > doge*doge_avg and (doge_avg*0.97 > current_price_doge or doge_avg*1.01 < current_price_doge) :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-DOGE", 200000)
                    post_message(myToken,"#amm", "DOGE buy: 200,000")

            #어제 종가 90% 이하, 가진 코인 없을때
            print ("gazua_doge")
            if current_price_doge < yesterday_price_doge*0.85 and 10000 > doge*doge_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-DOGE", 200000)
                    post_message(myToken,"#amm", "DOGE gazua: 200,000")
            ...
            if doge_avg*1.01 < current_price_doge and current_price_doge > yesterday_price_doge*0.90 :
                if doge*current_price_doge > 5000:
                    ...
                    post_message(myToken,"#amm", "DOGE sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_eth")
            if current_price_eth > yesterday_price_eth*0.90 and 10000 > eth*eth_avg and (eth_avg*0.97 > current_price_eth or eth_avg*1.01 < current_price_eth) :
                if krw > 200200:
            ...
            if current_price_eth < yesterday_price_eth*0.85 and 10000 > eth*eth_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-ETH", 200000)
                    post_message(myToken,"#amm", "ETH gazua: 200,000")
            ...
            if eth_avg*1.01 < current_price_eth and current_price_eth > yesterday_price_eth*0.90 :
                if eth*current_price_eth > 5000:
                    ...
                    post_message(myToken,"#amm", "ETH sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_eos")
            if current_price_eos > yesterday_price_eos*0.90 and 10000 > eos*eos_avg and (eos_avg*0.97 > current_price_eos or eos_avg*1.01 < current_price_eos) :
                if krw > 200200:
            ...
            if current_price_eos < yesterday_price_eos*0.85 and 10000 > eos*eos_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-EOS", 200000)
                    post_message(myToken,"#amm", "EOS gazua: 200,000")
            ...
            if eos_avg*1.01 < current_price_eos and current_price_eos > yesterday_price_eos*0.90 :
                if eos*current_price_eos > 5000:
                    ...
                    post_message(myToken,"#amm", "EOS sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_etc")
            if current_price_etc > yesterday_price_etc*0.90 and 10000 > etc*etc_avg and (etc_avg*0.97 > current_price_etc or etc_avg*1.01 < current_price_etc) :
                if krw > 200200:
            ...
            if current_price_etc < yesterday_price_etc*0.85 and 10000 > etc*etc_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-ETC", 200000)
                    post_message(myToken,"#amm", "ETC gazua: 200,000")
            ...
            if etc_avg*1.01 < current_price_etc and current_price_etc > yesterday_price_etc*0.90 :
                if etc*current_price_etc > 5000:
                    ...
                    post_message(myToken,"#amm", "ETC sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_xrp")
            if current_price_xrp > yesterday_price_xrp*0.90 and 10000 > xrp*xrp_avg and (xrp_avg*0.97 > current_price_xrp or xrp_avg*1.01 < current_price_xrp) :
                if krw > 200200:
            ...
            if current_price_xrp < yesterday_price_xrp*0.85 and 10000 > xrp*xrp_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-XRP", 200000)
                    post_message(myToken,"#amm", "XRP gazua: 200,000")
            ...
            if xrp_avg*1.01 < current_price_xrp and current_price_xrp > yesterday_price_xrp*0.90 :
                if xrp*current_price_xrp > 5000:
                    ...
                    post_message(myToken,"#amm", "XRP sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_btc")
            if current_price_btc > yesterday_price_btc*0.90 and 10000 > btc*btc_avg and (btc_avg*0.97 > current_price_btc or btc_avg*1.01 < current_price_btc) :
                if krw > 200200:
            ...
            if current_price_btc < yesterday_price_btc*0.85 and 10000 > btc*btc_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-BTC", 200000)
                    post_message(myToken,"#amm", "BTC gazua: 200,000")
            ...
            if btc_avg*1.01 < current_price_btc and current_price_btc > yesterday_price_btc*0.90 :
                if btc*current_price_btc > 5000:
                    ...
                    post_message(myToken,"#amm", "BTC sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_ada")
            if current_price_ada > yesterday_price_ada*0.90 and 10000 > ada*ada_avg and (ada_avg*0.97 > current_price_ada or ada_avg*1.01 < current_price_ada) :
                if krw > 200200:
            ...
            if current_price_ada < yesterday_price_ada*0.85 and 10000 > ada*ada_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-ADA", 200000)
                    post_message(myToken,"#amm", "ADA gazua: 200,000")
            ...
            if ada_avg*1.01 < current_price_ada and current_price_ada > yesterday_price_ada*0.90 :
                if ada*current_price_ada > 5000:
                    ...
                    post_message(myToken,"#amm", "ADA sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_bch")
            if current_price_bch > yesterday_price_bch*0.90 and 10000 > bch*bch_avg and (bch_avg*0.97 > current_price_bch or bch_avg*1.01 < current_price_bch) :
                if krw > 200200:
            ...
            if current_price_bch < yesterday_price_bch*0.85 and 10000 > bch*bch_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-BCH", 200000)
                    post_message(myToken,"#amm", "BCH gazua: 200,000")
            ...
            if bch_avg*1.01 < current_price_bch and current_price_bch > yesterday_price_bch*0.90 :
                if bch*current_price_bch > 5000:
                    ...
                    post_message(myToken,"#amm", "BCH sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_vet")
            if current_price_vet > yesterday_price_vet*0.90 and 10000 > vet*vet_avg and (vet_avg*0.97 > current_price_vet or vet_avg*1.01 < current_price_vet) :
                if krw > 200200:
            ...
            if current_price_vet < yesterday_price_vet*0.85 and 10000 > vet*vet_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-VET", 200000)
                    post_message(myToken,"#amm", "VET gazua: 200,000")
            ...
            if vet_avg*1.01 < current_price_vet and current_price_vet > yesterday_price_vet*0.90 :
                if vet*current_price_vet > 5000:
                    ...
                    post_message(myToken,"#amm", "VET sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_neo")
            if current_price_neo > yesterday_price_neo*0.90 and 10000 > neo*neo_avg and (neo_avg*0.97 > current_price_neo or neo_avg*1.01 < current_price_neo) :
                if krw > 200200:
            ...
            if current_price_neo < yesterday_price_neo*0.85 and 10000 > neo*neo_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-NEO", 200000)
                    post_message(myToken,"#amm", "NEO gazua: 200,000")
            ...
            if neo_avg*1.01 < current_price_neo and current_price_neo > yesterday_price_neo*0.90 :
                if neo*current_price_neo > 5000:
                    ...
                    post_message(myToken,"#amm", "NEO sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_link")
            if current_price_link > yesterday_price_link*0.90 and 10000 > link*link_avg and (link_avg*0.97 > current_price_link or link_avg*1.01 < current_price_link) :
                if krw > 200200:
            ...
            if current_price_link < yesterday_price_link*0.85 and 10000 > link*link_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-LINK", 200000)
                    post_message(myToken,"#amm", "LINK gazua: 200,000")
            ...
            if link_avg*1.01 < current_price_link and current_price_link > yesterday_price_link*0.90 :
                if link*current_price_link > 5000:
                    ...
                    post_message(myToken,"#amm", "LINK sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_bat")
            if current_price_bat > yesterday_price_bat*0.90 and 10000 > bat*bat_avg and (bat_avg*0.97 > current_price_bat or bat_avg*1.01 < current_price_bat) :
                if krw > 200200:
            ...
            if current_price_bat < yesterday_price_bat*0.85 and 10000 > bat*bat_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-BAT", 200000)
                    post_message(myToken,"#amm", "BAT gazua: 200,000")
            ...
            if bat_avg*1.01 < current_price_bat and current_price_bat > yesterday_price_bat*0.90 :
                if bat*current_price_bat > 5000:
                    ...
                    post_message(myToken,"#amm", "BAT sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_ltc")
            if current_price_ltc > yesterday_price_ltc*0.90 and 10000 > ltc*ltc_avg and (ltc_avg*0.97 > current_price_ltc or ltc_avg*1.01 < current_price_ltc) :
                if krw > 200200:
            ...
            if current_price_ltc < yesterday_price_ltc*0.85 and 10000 > ltc*ltc_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-LTC", 200000)
                    post_message(myToken,"#amm", "LTC gazua: 200,000")
            ...
            if ltc_avg*1.01 < current_price_ltc and current_price_ltc > yesterday_price_ltc*0.90 :
                if ltc*current_price_ltc > 5000:
                    ...
                    post_message(myToken,"#amm", "LTC sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_btg")
            if current_price_btg > yesterday_price_btg*0.90 and 10000 > btg*btg_avg and (btg_avg*0.97 > current_price_btg or btg_avg*1.01 < current_price_btg) :
                if krw > 200200:
            ...
            if current_price_btg < yesterday_price_btg*0.85 and 10000 > btg*btg_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-BTG", 200000)
                    post_message(myToken,"#amm", "BTG gazua: 200,000")
            ...
            if btg_avg*1.01 < current_price_btg and current_price_btg > yesterday_price_btg*0.90 :
                if btg*current_price_btg > 5000:
                    ...
                    post_message(myToken,"#amm", "BTG sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_pci")
            if current_price_pci > yesterday_price_pci*0.90 and 10000 > pci*pci_avg and (pci_avg*0.97 > current_price_pci or pci_avg*1.01 < current_price_pci) :
                if krw > 200200:
            ...
            if current_price_pci < yesterday_price_pci*0.85 and 10000 > pci*pci_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-PCI", 200000)
                    post_message(myToken,"#amm", "PCI gazua: 200,000")
            ...
            if pci_avg*1.01 < current_price_pci and current_price_pci > yesterday_price_pci*0.90 :
                if pci*current_price_pci > 5000:
                    ...
                    post_message(myToken,"#amm", "PCI sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_qtum")
            if current_price_qtum > yesterday_price_qtum*0.90 and 10000 > qtum*qtum_avg and (qtum_avg*0.97 > current_price_qtum or qtum_avg*1.01 < current_price_qtum) :
                if krw > 200200:
            ...
            if current_price_qtum < yesterday_price_qtum*0.85 and 10000 > qtum*qtum_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-QTUM", 200000)
                    post_message(myToken,"#amm", "QTUM gazua: 200,000")
            ...
            if qtum_avg*1.01 < current_price_qtum and current_price_qtum > yesterday_price_qtum*0.90 :
                if qtum*current_price_qtum > 5000:
                    ...
                    post_message(myToken,"#amm", "QTUM sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_dot")
            if current_price_dot > yesterday_price_dot*0.90 and 10000 > dot*dot_avg and (dot_avg*0.97 > current_price_dot or dot_avg*1.01 < current_price_dot) :
                if krw > 200200:
            ...
            if current_price_dot < yesterday_price_dot*0.85 and 10000 > dot*dot_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-DOT", 200000)
                    post_message(myToken,"#amm", "DOT gazua: 200,000")
            ...
            if dot_avg*1.01 < current_price_dot and current_price_dot > yesterday_price_dot*0.90 :
                if dot*current_price_dot > 5000:
                    ...
                    post_message(myToken,"#amm", "DOT sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_xlm")
            if current_price_xlm > yesterday_price_xlm*0.90 and 10000 > xlm*xlm_avg and (xlm_avg*0.97 > current_price_xlm or xlm_avg*1.01 < current_price_xlm) :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-XLM", 200000)
                    post_message(myToken,"#amm", "XLM buy: 200,000")
            ...
            if current_price_xlm < yesterday_price_xlm*0.85 and 10000 > xlm*xlm_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-XLM", 200000)
                    post_message(myToken,"#amm", "XLM gazua: 200,000")
            ...
            if xlm_avg*1.01 < current_price_xlm and current_price_xlm > yesterday_price_xlm*0.90 :
                if xlm*current_price_xlm > 5000:
                    ...
                    post_message(myToken,"#amm", "XLM sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_chz")
            if current_price_chz > yesterday_price_chz*0.90 and 10000 > chz*chz_avg and (chz_avg*0.97 > current_price_chz or chz_avg*1.01 < current_price_chz) :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-CHZ", 200000)
                    post_message(myToken,"#amm", "CHZ buy: 200,000")
            ...
            if current_price_chz < yesterday_price_chz*0.85 and 10000 > chz*chz_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-CHZ", 200000)
                    post_message(myToken,"#amm", "CHZ gazua: 200,000")
            ...
            if chz_avg*1.01 < current_price_chz and current_price_chz > yesterday_price_chz*0.90 :
                if chz*current_price_chz > 5000:
                    ...
                    post_message(myToken,"#amm", "CHZ sell: +1%")
            ...
            #어제 종가 90% 이상, 가진 코인 없을때, 평단가보다 현재가가 -3% or 1%
            print ("buy_snt")
            if current_price_snt > yesterday_price_snt*0.90 and 10000 > snt*snt_avg and (snt_avg*0.97 > current_price_snt or snt_avg*1.01 < current_price_snt) :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-SNT", 200000)
                    post_message(myToken,"#amm", "SNT buy: 200,000")
            ...
            if current_price_snt < yesterday_price_snt*0.85 and 10000 > snt*snt_avg :
                if krw > 200200:
                    buy_result = upbit.buy_market_order("KRW-SNT", 200000)
                    post_message(myToken,"#amm", "SNT gazua: 200,000")
            ...
            if snt_avg*1.01 < current_price_snt and current_price_snt > yesterday_price_snt*0.90 :
                if snt*current_price_snt > 5000:
                    ...
                    post_message(myToken,"#amm", "SNT sell: +1%")
