    ...
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=200):
            ...
            if target_price_ltc*1.20 < current_price_ltc:
                if ltc*current_price_ltc > 200000:
                    sell_result = upbit.sell_market_order("KRW-LTC", ltc*0.25)
            ...
            if target_price_link*1.20 < current_price_link:
                if link*current_price_link > 200000:
                    sell_result = upbit.sell_market_order("KRW-LINK", link*0.25)
            ...
            print ("gazua8")
            if current_price_ltc < yesterday_price_ltc*0.90 and current_price_ltc > yesterday_price_ltc*0.82 and 10000 > ltc*current_price_ltc:
                if krw > 200100:
            ...
            print ("gazua12")
            if current_price_link < yesterday_price_link*0.90 and current_price_link > yesterday_price_link*0.82 and 10000 > link*current_price_link:
                if krw > 200100:
