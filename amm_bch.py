...
print("BCH-autotradestart")
# 시작 메세지 슬랙 전송
post_message(myToken,"#amm", "BCH-autotradestart")
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=120):
            ...
            yesterday_price = get_yesterday_price("KRW-BCH")
            ...
            if target_price*1.20 < current_price:
                if btc*current_price > 100000:
                    sell_result = upbit.sell_market_order("KRW-BCH", btc*0.25)
            ...
            if current_price < yesterday_price*0.8:
                if btc*current_price > 5000:
                    sell_result = upbit.sell_market_order("KRW-BCH", btc*0.9995)
    ...
    #에러메세지 출력
        ...
        print(e)
        post_message(myToken,"#amm", "BCH error : " +e)
        time.sleep(1)